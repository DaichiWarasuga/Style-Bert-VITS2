def clean_text(text, language, use_debert_model_path_str, use_jp_extra=True, raise_yomi_error=False):
    ...
    if language == "ZH":
        ...
        phones, tones, word2ph = language_module.g2p(
            norm_text, use_debert_model_path_str, use_jp_extra, raise_yomi_error=raise_yomi_error
        )
    else:
